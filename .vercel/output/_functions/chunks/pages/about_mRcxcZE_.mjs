import { A as AstroError, h as InvalidImageService, i as ExpectedImageOptions, E as ExpectedImage, j as createAstro, c as createComponent, k as ImageMissingAlt, f as renderTemplate, m as maybeRenderHead, l as addAttribute, s as spreadAttributes, g as renderComponent, n as renderSlot, u as unescapeHTML, o as renderHead } from '../astro_V9-A_eD8.mjs';
import 'cssesc';
import 'kleur/colors';
import 'clsx';
/* empty css                           */
import { getIconData, iconToSVG } from '@iconify/utils';
import { i as isESMImportedImage, a as isLocalService, b as isRemoteImage, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_ER1hFDUu.mjs';
/* empty css                          */
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_ER1hFDUu.mjs'
    ).then(n => n.g).catch((e) => {
