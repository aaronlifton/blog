...
export async function GET({ props }: Props) {
  ...
  const DmSansBold = fs.readFileSync(path.resolve('public/fonts/dm-sans-latin-600-normal.ttf'));
  ...
  const downsizedPostCover = await getImage({src: postCover, width: 200, height: 200})
