...
import { type PaletteWithFallback } from "./types.ts";
...
export function generateCJS(content: Record<string, unknown>) {
	return `'use strict';
...
export function generateEsm(content: Record<string, string>) {
	return `
