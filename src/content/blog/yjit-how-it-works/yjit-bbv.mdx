---
title: How does the YJIT Ruby Compiler work?
description:
  "YJIT is a unique compiler based on the idea of Basic Block Versioning.  A
  deep dive into the simple concept that makes this JIT compiler unique: BBV
...
than the way it's been traditionally run – as a fairly slow interpreted
language.
