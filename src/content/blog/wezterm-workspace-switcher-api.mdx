...
<Admonition type="tip" isQuote={false} title="Note" date={"Apr 11, 2024"}>
  ...
  terminal to make Neovim faster. Kitty + `smart-splits.nvim` let's you navigate
  between Neovim and other terminal panes, even when Kitty is in stacked mode.
  This may replace the need for a multiplexer like tmux, which will make Neovim
  faster as there is no pseudoterminal in between.
  <Fragment slot="image">
