...
To accomplish this task, we need to set up tRPC and write a procedure that
...
Let's start by creating a new procedure call in a
`rpc-server/services/github.ts` file that fetches the contents of a file from a
