...
import image1 from "./assets/screenshots/octokit2.png";
...
is a directory, and a single object if the path is a file. Because of this, we
must the type by giving the typescript compiler a hint: returning early if the
response is an array. Check out the code snippet below, it has twoslash enabled
so you can hover over variables and see their Typescript type.
