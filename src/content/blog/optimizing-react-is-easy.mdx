...
everyone should be aware of this, for it is the #1 tool to prevent unnecessary re-renders in React.
...
>Be careful of using objects, arrays, or functions in state, or as props, as they are not primitive values. If you need to use objects, make sure to memoize them using `useMemo` or `useCallback` as necessary.
