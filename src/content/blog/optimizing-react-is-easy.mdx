...
description:
  "Follow one simple rule to know where to apply memoization, the single most
  important performance utility in React."
pubDate: "Dec 19 2023"
...
filters are introduced. Also, in our case, this doesn’t really work as the
