...
For another example, I ran 2 normal mode commands on the spot, when I was trying to convert colorspace function-less hsl colors from a shadcn install to oklch.
I have an Apple Studio Display, which makes me really appreciate the brighter colorspace of oklch.
