...
test.describe("Table of contents", () => {
  ...
  test("should remember user preference about toc being open/closed", async ({page,}) => {
    await page.goto("/posts/deriving-types-from-data-typescript");
  ...
  test("should highlight toc item when its corresponding heading comes into view", async ({page,}) => {
  ...
  test("should scroll to make toc item visible when its corresponding heading comes into view", async ({page,}) => {
    await page.goto("/posts/bash-for-javascript-developers");
